function getRandomInt(min, max) { // 返回min和max之间的一个随机数，包括max和min
...
export function debounce(func, delay) {  // 节流函数，延迟执行（search-box组件有用到） 参考：http://www.alloyteam.com/2012/11/javascript-throttle/
  let timer
