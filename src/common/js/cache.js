import storage from 'good-storage'  // 本地存储实现,封装localStorage和sessionStorage   https://github.com/ustbhuangyi/storage
...
function insertArray(arr, val, compare, maxLen) { // 插入数组中（10-12章节） （compare 为一个比较函数,maxLen为最大允许存储空间）
